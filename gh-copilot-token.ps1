...
# This will use the Device Code Flow to authenticate a user and obtain an access token for a GitHub App.
# This script is intended for use in environments where a web browser is available for user interaction.
# Make sure to use the Client ID (Not the App Id) of a GitHub OAuth App that has the necessary permissions for your use case.
